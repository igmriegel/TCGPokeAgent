...
| `uv run --frozen python scripts/restore_t034_replay_corpus.py` | Restore submission `55333874` replays into a staging directory, verify every frozen SHA-256, then publish the exact T-034 corpus |
