...
| T-026 | P0 | `IN_PROGRESS` | Eliminate Honchkrow/Porygon deck-out losses with committed 350-HP KO, draw-reserve, retreat, and terminal-cause guards | FB-2026-014, FB-2026-015, H2A | Review the exact `55374047` and current-baseline low-deck traces for one first causal objective/resource mistake; v13 confirms unguarded late Factory/Roto draw sequences, while `deck_reserve_v2` remains experimental after 2 deck-out losses in 200 bilateral matches, neither caused by an ignored low-deck lethal attack |
